...
Format: ```mngovernance prepare proposal-name url payment-count block-start dinero-address monthly-payment-dinero```
...
Format: ```mngovernance submit proposal-name url payment-count block-start dinero-address monthly-payment-dinero fee-tx```
...
The following RPC commands are supported:
 ...
 - mngovernance "command"... ( "passphrase" )
  ...
  - vote               - Vote on a proposal by single masternode (using dinero.conf setup)
