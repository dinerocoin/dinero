...
void BitcoinGUI::createActions()
{
    ...
    aboutAction = new QAction(QIcon(":/icons/" + theme + "/about"), tr("&About Dinero Core"), this);
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Dinero Core"));
    ...
    showHelpMessageAction->setStatusTip(tr("Show the Dinero Core help message to get a list with possible Dinero Core command-line options"));
